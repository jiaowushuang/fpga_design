...
void TD_Init(void)             // Called once at startup
{
  ...
  SYNCDELAY;
  PINFLAGSAB = 0x6A;            // FLAGB - fixed EP2FF  FLAGA - EP2EF
  SYNCDELAY;
  SYNCDELAY;
  SYNCDELAY;
  ...
  SYNCDELAY;
  SYNCDELAY;
  PORTACFG = 0x80;              // func. of PA7 pin is SLCS#
  SYNCDELAY;
  SYNCDELAY;
  SYNCDELAY;
  ...
  SYNCDELAY;
  EP2CFG = 0x00;		    	//EP2 OUT, 512BYTE BULK, DUBBLE BUFFER
  SYNCDELAY;
  SYNCDELAY;
  SYNCDELAY;        
  EP4CFG = 0x00;               	//EP4 OUT, BULK
  SYNCDELAY;
  SYNCDELAY;
  SYNCDELAY;        
